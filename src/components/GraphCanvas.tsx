...
const creatableNodeTypes: NodeType[] = ["passage", "choice", "fake_choice", "if", "label", "goto", "goto_scene", "gosub", "input_text", "input_number", "rand", "page_break", "checkpoint", "comment", "ending"];
