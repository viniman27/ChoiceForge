...
- **Editor CodeMirror de código-fonte**: entre em qualquer cena como ChoiceScript bruto, depois converta de volta pro grafo visual. Editores de body mostram chips inline com o valor inicial ao lado de `${var}` — facilita revisão sem precisar traduzir identificadores mentalmente.
