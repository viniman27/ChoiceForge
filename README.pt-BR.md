...
| Testes | Test runner nativo do Node (`node --test`) — 382 testes |
...
Os testes vivem em `tests/domain.test.ts` e cobrem a camada de domínio pura (gerador de código, importador, linter, layout). O total atual é **382 passando**.
